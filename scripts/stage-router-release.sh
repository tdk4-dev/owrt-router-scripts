...
if [ "$RELEASE_CHANNEL" = candidate ]; then
  ...
  PROTOCOL2_TRANSITIONS='[{"source_version":"0.7.11-rc.14","source_protocol":2,"mode":"package-v2-rc"},{"source_version":"0.7.11-rc.15","source_protocol":2,"mode":"package-v2-rc"}]'
fi
