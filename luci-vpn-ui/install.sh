...
ensure_source_files() {
  if [ -f "$SRC_DIR/usr/sbin/vpn-ui" ] &&
    ...
    [ -f "$SRC_DIR/www/luci-static/resources/view/network/tailscale-0-7-4.js" ] &&
...
copy_file "$SRC_DIR/www/luci-static/resources/view/network/tailscale-0-7-4.js" /www/luci-static/resources/view/network/tailscale-0-7-4.js 644
