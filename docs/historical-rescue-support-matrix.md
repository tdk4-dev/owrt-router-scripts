...
`tests/vm/legacy-baseline-lock.json`. The one final rescue entry point is
pinned to 0.7.11 and every supported source converges on the same three
canonical 0.7.11-1 IPK bytes.
