...
grep -q 'CANDIDATE_RUN_ID: "29770661240"' "$DIAGNOSTIC_WORKFLOW"
grep -q 'CANDIDATE_ARTIFACT_ID: "8473240890"' "$DIAGNOSTIC_WORKFLOW"
grep -q 'CANDIDATE_SOURCE_SHA: 373d88c3636340d1610187992ec256ecdf65e123' "$DIAGNOSTIC_WORKFLOW"
...
grep -q "P_HOST='192.0.2.1'" "$VM_GUEST"
grep -q 'domain:router-ui-vm.invalid' "$VM_GUEST"
grep -q 'private_key_present:false' "$VM_GATE"
