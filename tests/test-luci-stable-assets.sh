...
grep -q 'network/vpn-0-7-0.js' "$INSTALLER"
grep -q 'network/tailscale-0-7-5.js' "$INSTALLER"
grep -q 'system/update-0-7-3.js' "$INSTALLER"
grep -q 'status/include/35_vpn-0-7-0.js' "$INSTALLER"
grep -q 'status/include/_35_vpn-0-7-0.js' "$INSTALLER"
grep -q 'rm -f /www/luci-static/resources/view/network/vpn-0-7-6.js' "$INSTALLER"
! grep -q 'rm -f /www/luci-static/resources/view/network/vpn-0-7-0.js' "$INSTALLER"
