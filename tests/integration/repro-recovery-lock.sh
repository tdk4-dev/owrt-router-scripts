...
CANDIDATE_DIR="${ROUTER_UI_CANDIDATE_DIR:-$REMOTE_ROOT/assets/release-v0.7.11-rc.12}"
EXPECTED_SOURCE_SHA="${ROUTER_UI_CANDIDATE_SOURCE_SHA:-}"
REMOTE_SOURCE_ROOT="${ROUTER_UI_MAC_PRO_SOURCE_ROOT:-/Users/mac-pro-host/Documents/RouterUI-release/Premier-Router-0.7.11-rc12-worktree}"
