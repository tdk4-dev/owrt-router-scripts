...
EXPECTED_CANDIDATE_APP_VERSION=0.7.11-rc.12
EXPECTED_CANDIDATE_PACKAGE_VERSION=0.7.11~rc12-1
...
[[ "$SOURCE_ROOT" = /Users/mac-pro-host/Documents/RouterUI-release/Premier-Router-0.7.11-rc12-worktree ]] ||
  fail 'source root is not the isolated RC12 worktree'
