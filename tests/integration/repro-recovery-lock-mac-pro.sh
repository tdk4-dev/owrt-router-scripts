...
EXPECTED_CANDIDATE_APP_VERSION=0.7.11-rc.15
EXPECTED_CANDIDATE_PACKAGE_VERSION=0.7.11~rc15-1
...
[[ "$SOURCE_ROOT" = /Users/mac-pro-host/Documents/RouterUI-release/Premier-Router-0.7.11-rc15-worktree ]] ||
  fail 'source root is not the isolated RC15 worktree'
