...
# RC5 wrote no protected-validation pair. The RC12 reboot path may bridge only
...
prepare_rc5_reboot_transaction() {
  ...
  local cron_expected="$TMP_ROOT/rc12-expected-root.cron"
...
# them. The next RC5 -> RC12 reboot must accept that complete byte-bound shape,
