...
`);
	...
	const textareas = {
		'#vpn-direct-domains': { value: 'full:one.rc12.invalid\ndomain:two.rc12.invalid' },
	...
	textareas['#vpn-direct-domains'].value = 'full:must-rollback.rc12.invalid';
