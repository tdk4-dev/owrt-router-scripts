...
`);
	...
	const textareas = {
		'#vpn-direct-domains': { value: 'full:one.rc11.invalid\ndomain:two.rc11.invalid' },
	...
	textareas['#vpn-direct-domains'].value = 'full:must-rollback.rc11.invalid';
