...
`);
	...
	const textareas = {
		'#vpn-direct-domains': { value: 'full:one.rc10.invalid\ndomain:two.rc10.invalid' },
	...
	textareas['#vpn-direct-domains'].value = 'full:must-rollback.rc10.invalid';
