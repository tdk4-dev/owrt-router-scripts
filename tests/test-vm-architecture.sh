...
VIRTUALBOX_PUBLISH="$ROOT_DIR/.github/workflows/publish-router-ui-rc7-virtualbox-evidence.yml"
VIRTUALBOX_VALIDATOR="$ROOT_DIR/tests/integration/validate-rc7-virtualbox-evidence.sh"
...
grep -q 'publish-router-ui-rc7-virtualbox-evidence.yml' "$CANDIDATE" ||
...
grep -q 'validate-rc7-virtualbox-evidence.sh' "$CANDIDATE" ||
